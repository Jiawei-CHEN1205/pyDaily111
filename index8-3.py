...
class HeroPlane(object):
    def __init__(self,screen) -> None:
        ...
        # 生成飞机的图片对象
        self.imageName = 'C:/A--HITsz_files/4--learnPY/qiuzhi_feiji/feiji/hero_teacher.png'
...
class EnemyPlane(HeroPlane):
    def __init__(self,screen) -> None:
        ...
        # 生成敌人飞机的图片对象
        self.imageName = 'C:/A--HITsz_files/4--learnPY/qiuzhi_feiji/feiji/enemy_teacher.png'
        self.image = pygame.image.load(self.imageName)
        self.image = pygame.transform.scale(self.image,(30,30))# 改变图片的大小 这句话可以忽略 我本身设计的图片就是50*50 建议用画图工具调整大小
...
class EnemyBullet():
    def __init__(self,x,y,screen) -> None:
        ...
        '''
        self.x = x+15  # 子弹的坐标self.x是相对于敌机的坐标位置而定义的
        self.y = y+21+50
        self.screen = screen # 这里的screen之类的都是形式参数
        # 导入子弹的图片9*21大小
